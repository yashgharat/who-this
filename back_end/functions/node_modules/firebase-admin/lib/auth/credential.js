...
var RefreshTokenCredential = /** @class */ (function () {
    function RefreshTokenCredential(refreshTokenPathOrObject, httpAgent) {
        if (typeof refreshTokenPathOrObject === 'string') {
            var refreshToken = RefreshToken.fromPath(refreshTokenPathOrObject);
            if (!refreshToken) {
                throw new error_1.FirebaseAuthError(error_1.AuthClientErrorCode.NOT_FOUND, 'The file refered to by the refreshTokenPathOrObject parameter (' +
